10 ' SUPER STARTREK - MAY 16,1978 - REQUIRES 24K MEMORY
30 '
40 ' ****        **** STAR TREK ****        ****
50 ' **** SIMULATION OF A MISSION OF THE STARSHIP ENTERPRISE,
60 ' **** AS SEEN ON THE STAR TREK TV SHOW.
70 ' **** ORIGIONAL PROGRAM BY MIKE MAYFIELD, MODIFIED VERSION
80 ' **** PUBLISHED IN DEC'S "101 BASIC GAMES", BY DAVE AHL.
90 ' **** MODIFICATIONS TO THE LATTER (PLUS DEBUGGING) BY BOB
100 ' *** LEEDOM - APRIL & DECEMBER 1974,
110 ' *** WITH A LITTLE HELP FROM HIS FRIENDS . . .
120 ' *** COMMENTS, EPITHETS, AND SUGGESTIONS SOLICITED --
130 ' *** SEND TO:  R. C. LEEDOM
140 ' ***           WESTINGHOUSE DEFENSE & ELECTRONICS SYSTEMS CNTR.
150 ' ***           BOX 746, M.S. 338
160 ' ***           BALTIMORE, MD  21203
170 ' ***
180 ' *** CONVERTED TO MICROSOFT 8 K BASIC 3/16/78 BY JOHN GORDERS
190 ' *** LINE NUMBERS FROM VERSION STREK7 OF 1/12/75 PRESERVED AS
200 ' *** MUCH AS POSSIBLE. WHILE USING MULTIPLE STATEMENTS PER LINE
205 ' *** SOME LINES ARE LONGER THAN 72 CHARACTERS; THIS WAS DONE
210 ' *** BY USING "?" INSTEAD OF "PRINT" WHEN ENTERING LINES
215 ' ***
...
260 Rem CLEAR 600
270 ZZ$="                         "
330 Dim G(8,8),C(9,2),K(3,3),NN(3),Z(8,8),D(8)
370 T=Int(Rnd(1)*20+20)*100:T0=T:T9=25+Int(Rnd(1)*10):D0=0:E=3000:E0=E
440 P=10:P0=P:S9=200:S=0:B9=2:K9=0:XX$="":X0$=" IS "
470 Function FND(D): FND=Sqr((K(I,1)-S1)^2+(K(I,2)-S2)^2):End Function
475 Function FNR(R): FNR=Int(Rnd(R)*7.98+1.01):End Function
...
1200 K7=K9:If B9<>1 Then XX$="S":X0$=" ARE "
...
1600 For I=1 To 3:K(I,3)=0:Next I:Q$=ZZ$+ZZ$+ZZ$+ZZ$+ZZ$+ZZ$+ZZ$+Left$(ZZ$,17)
1660 Rem POSITION ENTERPRISE IN QUADRANT, THEN PLACE "K3" KLINGONS, &
1670 Rem "B3" STARBASES, & "S3" STARS ELSEWHERE.
1680 aa$="<*>":Z1=S1:Z2=S2:GoSub 8670:If K3<1 Then goto 1820
1720 For I=1 To K3:GoSub 8590:aa$="+K+":Z1=R1:Z2=R2
1780 GoSub 8670: K(I,1)=R1:K(I,2)=R2:K(I,3)=S9*(0.5+Rnd(1)):Next I
1820 If B3<1 Then goto 1910
1880 GoSub 8590: aa$=">!<":Z1=R1:B4=R1:Z2=R2:B5=R2:GoSub 8670
1910 For I=1 To S3:GoSub 8590:aa$=" * ":Z1=R1:Z2=R2:GoSub 8670:Next I
1980 GoSub 6430
...
2080 For I=1 To 9:If Left$(aa$,3)<>Mid$(A1$,3*I-2,3)Then goto 2160
...
3170 For I=1 To N:S1=S1+X1:S2=S2+X2:If S1<1 Or S1>=9 Or S2<1 Or S2>=9 Then goto 3500
...
6490 aa$=">!<":Z1=I:Z2=J:GoSub 8830:If Z3=1 Then goto 6580
...
8590 R1=FNR(1):R2=FNR(1):aa$="   ":Z1=R1:Z2=R2:GoSub 8830:If Z3=0 Then goto 8590
8600 Return
